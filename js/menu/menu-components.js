...
Завтрак ~${bCal}ккал, Обед ~${lCal}ккал, Ужин ~${dCal}ккал. Но я каждый день пью банку колы, не забывай про это
...
И давай договоримся - я не люблю смузи (но не имею ничего против другой пюрерированной пищи)
